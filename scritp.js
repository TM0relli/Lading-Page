function mostrarPagina(pagina){
    ...
    if(pagina === "sobre"){
        ...
        <section> 
        <h2> Sobre mim</h2>
        <p>Desenvolvedor com foco em Front-End, performance e resultados.</p>
        </section> `;
        ...
        conteudo.innerHTML = `
          <section>
            ...
            <a href="Seu Email" class="btn"> E-mail</a><br><br>
        ...
        conteudo.innerHTML = `
        <header> 
        <h1> Olá, sou <span class="destaque"> Seu Nome</span></h1>
